<template>
    <div class="flex flex-wrap font-sans text-xs sm:text-sm md:text-base">
        <div
...
export default {
    ...
    methods: {
        classesFor (theme) {
            switch (theme) {
                case 'category':
                    return 'border-transparent bg-gray-300 text-gray-700 text-xs md:text-sm font-semibold uppercase tracking-wider'

                case 'highlighted':
                    return 'border-transparent bg-topaz text-white'

                default:
                    return 'text-gray-800 md:text-gray-700'
            }
        }
    }
}
